 ...
 */
import * as fromCampaigns from './campaigns';
 ...
 * ```
 */
export const getCampaignsState = (state: State) => state.campaigns;
 ...
 * first select the campaigns state then we pass the state to the campaign
 * reducer's getCampaigns selector, finally returning an observable
 * of search results.
 *
 ...
 */
export const getCampaignsEntities = createSelector(getCampaignsState, fromCampaigns.getEntities);
